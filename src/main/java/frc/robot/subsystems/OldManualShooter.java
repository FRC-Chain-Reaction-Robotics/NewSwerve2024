...
/* Github testing */
@Deprecated
public class OldManualShooter extends SubsystemBase {
   ...
   public OldManualShooter(Swerve m_Swerve, OldPneumaticsSubsystem m_PneumaticsSubsystem) {
   ...
   // MODIFY IT TO WHERE IT WILL EXTEND TO INTAKE POSITION, SUCKS THE RING IN, AND
   // THEN GO BACK TO NORMAL POSITION
